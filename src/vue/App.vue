<template>
  <div class="flex flex-col items-center justify-center h-full font-typoldRegular tracking-tight p-10">
    <div class="flex flex-col items-center justify-center mb-8">
      ...
      <p id = "version"></p>
      <button @click="compareAndUpdate" :disabled="isButtonDisabled" className="btn bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline-blue active:bg-blue-800">
        {{ isButtonDisabled ? 'Téléchargement en cours ...' : 'Jouer' }}
      </button>
